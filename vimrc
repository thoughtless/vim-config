...
" For some reason lodestone only works if we load vibrantink first..
...
" Don't wrap lines by default. Can be change on a per-buffer basis
" with :set wrap
set nowrap
...
" Requires plugins/snippetsEmu.vim
" Snippets are define in after/ftplugin/ruby.vim
...
" a => Use abbreviations for status messages to make lines shorter
" t => Chop the beginning portion of file lines, indicating the truncation
"      with a < sign at the point of truncation.
" I => Don't give the intro message when starting Vim
set shortmess=atI

" Allow switching between buffers without saving. Be careful!
set hidden
...
set wildignore+=spec/reports/**,tmp/reports/**,tmp/cache/**,tmp/sass-cache/**,.git/**,.DS_Store/**,.jhw-cache/**,node_modules/**,tmp/**,cordova-build/*
